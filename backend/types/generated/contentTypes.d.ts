...
export interface ApiCafeTableCafeTable extends Struct.CollectionTypeSchema {
  collectionName: 'cafe_tables';
  info: {
    displayName: 'Cafe Table';
    pluralName: 'cafe-tables';
    singularName: 'cafe-table';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCafeCafe extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coffee shop location/branch';
    displayName: 'Cafe';
    pluralName: 'cafes';
    singularName: 'cafe';
  };
...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Raw ingredients for inventory management';
...
export interface ApiInventoryTransactionInventoryTransaction
  ...
  info: {
    description: 'Stock movement records for ingredients';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    newQty: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    previousQty: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    type: Schema.Attribute.Enumeration<
      ['sale', 'supply', 'writeoff', 'adjustment']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiModifierGroupModifierGroup
  extends Struct.CollectionTypeSchema {
  collectionName: 'modifier_groups';
  info: {
    description: 'Groups of modifiers (e.g., Size, Add-ons)';
    displayName: 'Modifier Group';
    pluralName: 'modifier-groups';
    singularName: 'modifier-group';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    maxSelections: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    minSelections: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    modifiers: Schema.Attribute.Relation<'oneToMany', 'api::modifier.modifier'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
...
export interface ApiModifierModifier extends Struct.CollectionTypeSchema {
  collectionName: 'modifiers';
  info: {
    description: 'Product modifiers (e.g., Small, Medium, Large, Extra shot)';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    modifierGroup: Schema.Attribute.Relation<
      'manyToOne',
      'api::modifier-group.modifier-group'
    >;
    name: Schema.Attribute.String &
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    modifiers: Schema.Attribute.JSON;
    notes: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    order: Schema.Attribute.Relation<'manyToOne', 'api::order.order'>;
    preparedAt: Schema.Attribute.DateTime;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    discountValue: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    estimatedPrepTime: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    preparedAt: Schema.Attribute.DateTime;
    priority: Schema.Attribute.Enumeration<['normal', 'rush']> &
    ...
    total: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    type: Schema.Attribute.Enumeration<['dine_in', 'takeaway', 'delivery']> &
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    changeAmount: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    receivedAmount: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    tipAmount: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu products and items';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    modifierGroups: Schema.Attribute.Relation<
      'manyToMany',
      'api::modifier-group.modifier-group'
    >;
    name: Schema.Attribute.String &
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product recipes linking products to ingredients by size';
    displayName: 'Recipe';
    pluralName: 'recipes';
    singularName: 'recipe';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    preparationNotes: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
    price: Schema.Attribute.Decimal &
    ...
    sizeVolume: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiShiftShift extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Barista work shifts with cash tracking';
    displayName: 'Shift';
    pluralName: 'shifts';
    singularName: 'shift';
  };
  ...
  attributes: {
    ...
    cardSales: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    cashSales: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    closingCash: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    openedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    openedBy: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    openingCash: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    ordersCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    suppliesTotal: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    writeOffsTotal: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiSupplySupply extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ingredient supply orders from suppliers';
    displayName: 'Supply';
    pluralName: 'supplies';
    singularName: 'supply';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdBy_barista: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    ...
    receivedBy: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    shift: Schema.Attribute.Relation<'manyToOne', 'api::shift.shift'>;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Daily tasks and assignments for cafe workers';
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['daily', 'task']> &
      Schema.Attribute.Required &
...
export interface ApiWriteOffWriteOff extends Struct.CollectionTypeSchema {
  collectionName: 'write_offs';
  info: {
    description: 'Ingredient and product write-offs';
    displayName: 'Write Off';
    pluralName: 'write-offs';
    singularName: 'write-off';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    totalCost: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    type: Schema.Attribute.Enumeration<['expired', 'damaged', 'other']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::modifier-group.modifier-group': ApiModifierGroupModifierGroup;
      'api::modifier.modifier': ApiModifierModifier;
